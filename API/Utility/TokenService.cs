...
using System.Text;
using static API.Utility.TokenService;
    ...
    public class TokenService : ITokenService
    {
        ...
        public ClaimVM ExtractClaimsFromJwt(string token)
        {
            ...
            try
            {
                ...
                {
                    ValidateIssuer = false, //true jika ada issuer
                    ValidateAudience = false, // true jika ada audience
        ...
        public string GenerateToken(IEnumerable<Claim> claims)
        {
            ...
            var tokenOptions = new JwtSecurityToken(issuer: _configuration["JWT:Issuer"], audience: _configuration["JWT:Audience"],
        ...
        public string GeneratrRefreshToken()
        {
